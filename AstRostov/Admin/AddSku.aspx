...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:Repeater runat="server" ID="rptAttributes" OnItemDataBound="OnAttributeItemDataBound">
            <ItemTemplate>
                <div class="control-group attr-config">
                    <asp:Label runat="server" ID="lblAttributeTitle" CssClass="control-label attr-name"></asp:Label>
                    <div class="controls">
                        <ucc:AutocompleteTextbox runat="server" ID="tbAttributeValue" CssClass="attr-value"></ucc:AutocompleteTextbox>
                    </div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
        <div class="control-group add-attr">
            <span class="control-label"></span>
            <div class="controls">
                <span class="btn btn-success" id="btnAddAttribute">Добавить связку атрибут/значение</span>
            </div>
        </div>
    ...
    <div id="templateHolder" style="display: none;">
        <div class="control-group attr-config">
            <input type="text" class="control-label attr-name" placeholder="Название атрибута" onchange="toggleDefaultValue(this);" />
            <div class="controls">
                <input type="text" class="attr-value" placeholder="Значение" />
                <input type="text" class="attr-default-value" placeholder="Значение по умолчанию" style="display: none;" />
            </div>
        </div>
    </div>
    <hr />
    ...
    <asp:LinkButton runat="server" ID="btnSave" CssClass="btn btn-success" Text="Сохранить" OnClick="SaveSku" OnClientClick="return FormatAttributeDictionary();" />
</asp:Content>
